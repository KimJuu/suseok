          ...
          <form name="frm" id="frm" action="" onsubmit="" method="post" >
            <div className="row uniform">
              <div className="6u 12u$(xsmall)">
                <input name="qna_name" id="qna_name" placeholder="Name" type="text" />
              </div>
              <div className="6u$ 12u$(xsmall)">
                <input name="qna_hp" id="qna_hp" placeholder="Email" type="text" />
              </div>
              <div className="12u$">
                <textarea
                  name="qna_content"
            ...
            <ul className="actions">
              <li>
                <a href="javascript:" className="alt" onClick={(e) => this.submitClick('save', e)}>문의하기</a>
              </li>
            </ul>
          </form>
        </section>
